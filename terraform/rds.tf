...
resource "aws_rds_cluster" "aurora_cluster" {
  ...
  db_cluster_parameter_group_name = aws_rds_cluster_parameter_group.aurora_pg14_cluster.name
  ...
  depends_on = [
    aws_rds_cluster_parameter_group.aurora_pg14_cluster,
...
resource "aws_rds_cluster_instance" "aurora_instance" {
  ...
  db_parameter_group_name = aws_db_parameter_group.aurora_pg14_instance.name
  ...
  depends_on = [
    aws_db_parameter_group.aurora_pg14_instance,
